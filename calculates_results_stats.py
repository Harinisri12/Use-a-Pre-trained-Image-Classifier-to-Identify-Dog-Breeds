...
def calculates_results_stats(results_dic):
    ...
    """        
    # Initialize empty dictionary for results statistics
    results_stats_dic = {}
    ...
    # Iterate through results_dic to count metrics
    ...
    # Add calculated statistics to results_stats_dic
